...
export default async function UnitDetailItem({ params }: { params: { id: string } }) {
  ...
  return (
        <div>
            ...
            <div className="flex justify-between items-center rounded-lg text-white text-sm p-1 bg-black snap-start cursor-pointer hover:brightness-75 transition-all">
