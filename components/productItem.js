    ...
    return (
        <Link href={`/product/${product.id}`} >
            ...
            <div className="flex items-center justify-between pl-2 ">
                <img src={product.author.avatar} className="w-40 border rounded-2xl pt-2" alt=""/>
                <div className="pl-4 mr-4 font font-dancing">
                    <div>
                        <h5 className="text-sm font-semibold line-clamp-1">{product.subtitle}</h5>
                        <p className="text-sm text-gray-500">{product.author.name}</p>
                        <p className="text-sm font-bold text-gray-600 bg-gray-200 rounded-2xl p-2 mt-2">Best Price <span className="text-gray-900 text-lg">£335</span></p>
            ...
            <div className="flex justify-between items-center text-sm  pt-1 pl-2 pr-2 bg-gray-100 ">
                ...
                <p className="pr-2">3 Bed</p>
                <UserGroupIcon className="h-5 w-5" />
                <p className="pr-2">Sleeps 3</p>
                <UserGroupIcon className="h-5 w-5" />
                <p className="pr-2">2 Baths</p>
           ...
           <div className="flex justify-end items-center" >
            ...
            <div className="flex justify-between items-center text-sm p-1  bg-gray-300  rounded-bl-2xl rounded-br-2xl font-semibold snap-start cursor-pointer hover:brightness-75 transition-all">
                ...
                <p className="mr-8">The Grange Leisure Park</p>
